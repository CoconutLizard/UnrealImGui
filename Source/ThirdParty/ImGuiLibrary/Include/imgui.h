...
struct ImVec2
{
    ...
    IM_VEC2_CLASS_EXTRA
#endif
	friend ImVec2 operator+(ImVec2 lhs, float rhs)
	{
...
namespace ImGui
{
	...
	IMGUI_API bool          DragFloatButton(const char* label, float* v, float v_speed = 1.0f, float v_min = 0.0f, float v_max = 0.0f, const char* display_format = "%.3f", float power = 1.0f, bool bDown = false);
    ...
    IMGUI_API bool          InputText(const char* label, char* buf, size_t buf_size, ImGuiInputTextFlags flags = 0, ImGuiTextEditCallback callback = NULL, void* user_data = NULL, bool* bIsClicked = NULL);
...
enum ImGuiTreeNodeFlags_
{
	...
	ImGuiTreeNodeFlags_Highlight			= 1 << 11,
...
enum ImGuiKey_
{
	...
	ImGuiKey_T,         // for text edit CTRL+Z: undo
	ImGuiKey_SpaceBar,
    ImGuiKey_COUNT
};
...
namespace ImGui
{
	...
	IMGUI_API inline ImGuiUserStyle& GetUserStyle()
	{
	...
	IMGUI_API inline TabBarStack& GetTabBarStack() 
	{
